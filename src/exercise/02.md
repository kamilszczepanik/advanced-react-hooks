...
### useAsync hook that maybe needed

### //\* throw error is resolved by react error boundary !!! line 78 - very comfortable

Error boundary can handle app error(e.g."something is wrong"), api error(e.g.
"cannot get pokemons") every other error! use it in app wisely
